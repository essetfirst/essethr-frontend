...
const payrolls = {
  ...
  lock: (payrollId) => postRequest(`${payrollPath}/${payrollId}/lock`),
  finalize: (payrollId) => postRequest(`${payrollPath}/${payrollId}/finalize`),
  addAdjustment: (payrollId, data) => postRequest(`${payrollPath}/${payrollId}/adjustments`, data),
