...
function getActivity(id) {
  return getRequest(`${path}/${id}/activity`);
}

function getProfileCompletion(id) {
  return getRequest(`${path}/${id}/profile-completion`);
}
...
function transfer(id, data) {
  return postRequest(`${path}/${id}/transfer`, data);
}
