import { fmt, parseTime } from "utils/date";
      ...
      <Grid item xs={12} sm={12} md={6}>
        <TextField
          ...
          value={
            editable
              ? workStartTime
              : fmt(parseTime(workStartTime), "hh:mm a")
          }
          onChange={onChange}
          variant="outlined"
          margin="dense"
      ...
      <Grid item xs={12} sm={12} md={6}>
        <TextField
          ...
          value={
            editable
              ? workEndTime
              : fmt(parseTime(workEndTime), "hh:mm a")
          }
          onChange={onChange}
          variant="outlined"
          margin="dense"
      ...
      <Grid item xs={12} sm={12} md={6}>
        <TextField
          ...
          value={
            editable
              ? breakStartTime
              : fmt(parseTime(breakStartTime), "hh:mm a")
          }
          onChange={onChange}
          variant="outlined"
          margin="dense"
      ...
      <Grid item xs={12} sm={12} md={6}>
        <TextField
          ...
          value={
            editable
              ? breakEndTime
              : fmt(parseTime(breakEndTime), "hh:mm a")
          }
          onChange={onChange}
          variant="outlined"
          margin="dense"
