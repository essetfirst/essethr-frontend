import { diffHours, fmt, toDate } from "utils/date";
...
const DEFAULT_TIMESHEETS = [
  {
    ...
    // checkin: toDate(Date.now()).subtract(14, "hours").unix(),
    // workStartTime: new Date().setHours(8, 30),
    // breakStartTime: new Date().setHours(12, 30),
    // breakout: toDate(Date.now()).subtract(8, "hours").unix(),
    // breakin: toDate(Date.now()).subtract(7, "hours").unix(),
    // breakEndTime: new Date().setHours(14, 0),
    // workEndTime: new Date().setHours(17, 30),
    // checkout: toDate(Date.now()).subtract(3, "hours").unix(),
  },
  {
    avatar: "",
    initials: "EH",
