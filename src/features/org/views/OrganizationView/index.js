...
import { Backdrop, Box, Card, Container, Divider, Grid, Typography, colors } from "@mui/material";
...
/** Typography cannot render `address` as an object `{ city, region, ... }`; stringify for display. */
function formatOrgAddressLabel(addr) {
                ...
                <StyledCard>
                  ...
                  >
                    {[
                      ...
                      {
                        label: formatOrgAddressLabel(state.org.address),
                        icon: <AddressIcon fontSize="small" />,
                        color: colors.green[400],
                      },
                      {
                        label: `Total Employees: ${
                          Array.isArray(state.org.employees)
                            ? state.org.employees.length
                            : 0
                        }`,
